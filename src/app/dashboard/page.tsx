...
import { mockUser, getCampaignsByOwner, getCampaignsByDonor, formatAddress, weiToEth } from "@/lib/mockData"
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setMyCampaigns(getCampaignsByOwner(mockUser))
      setMyDonations(getCampaignsByDonor(mockUser))
      setIsLoading(false)
    }, 1500)
