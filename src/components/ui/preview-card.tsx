...
import { type Campaign, weiToEth, gweiToEth, PreviewCampaign } from "@/lib/mockData"
...
export function PreviewCard({ campaign, index = 0 }: CampaignCardProps) {
        ...
        <CardContent className="p-4">
          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-lg font-bold text-white">{weiToEth(campaign.totalAmountRaised).toFixed(2)} ETH</p>
          ...
          <div className="grid grid-cols-2 gap-2 text-center">
            <div className="rounded-lg bg-slate-800/50 p-2">
              <p className="text-xs text-slate-400 text">Donors</p>
              <p className="font-bold text-white">{campaign.totalDonors}</p>
            </div>
            <div className="rounded-lg bg-slate-800/50 p-2">
              <p className="text-xs text-slate-400">Granted</p>
              <p className="font-bold text-white">{(campaign.fundingGranted).toFixed(2)} ETH</p>
            </div>
          </div>
